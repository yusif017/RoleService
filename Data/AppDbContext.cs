...
protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    ...
    modelBuilder.Entity<RolePermission>().HasData(
        new RolePermission
        {
            Id = Guid.Parse("a3f01a5b-c6f1-4f9e-8425-97e2e2c02a5e"),
            RoleId = Guid.Parse("c56a4180-65aa-42ec-a945-5fd21dec0538"),
            PermissionName = "Product.Create"
        },
        new RolePermission
        {
            Id = Guid.Parse("e19d62d4-c3a7-4c1b-84aa-fb54505db8b1"),
            RoleId = Guid.Parse("c56a4180-65aa-42ec-a945-5fd21dec0538"),
            PermissionName = "Product.Update"
        },
        new RolePermission
        {
            Id = Guid.Parse("f27e5d1a-7ad6-41b7-8d45-0f65b2d6cd18"),
            RoleId = Guid.Parse("d14a1f59-8e8a-4f30-8f16-247d7e47d9c3"),
